...
public class CheckCartController extends HttpServlet {
    private static final String LESS = "viewCart.jsp";
    private static final String ENOUGH = "viewCart.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            int quantity = Integer.parseInt(request.getParameter("quantity"));
                if(quantity < amount){
                    String msg = fruitID + " out of stock " + ". Only: " + quantity + "left!";
                    request.setAttribute("AMOUNT_MESSAGE", msg);
                    url = LESS;
